...
for group in groups:
    ...
    plt.subplot(131)
    plt.plot(df_target['Roll'], df_target['Cz'], '-o', linewidth=2)
    ...
    plt.subplot(132)
    plt.plot(df_target['Roll'], df_target['Cx'], '-o', linewidth=2)
    plt.gca().invert_xaxis()
    plt.title('Cx')
    plt.xlabel('roll [deg]')
    plt.ylabel('Cx')
    ...
    plt.subplot(133)
    plt.plot(df_target['Roll'], df_target['AB'], '-o', linewidth=2)
    plt.gca().invert_xaxis()
    plt.title('AB')
    plt.xlabel('roll [deg]')
    plt.ylabel('AB')
